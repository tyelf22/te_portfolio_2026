        ...
        <aside className="w-[260px] bg-chatgpt-sidebar flex flex-col h-dvh md:h-screen">
            ...
            <div className="flex-1 overflow-y-auto px-2 py-4">
                ...
                <nav className="space-y-1.5">
                    ...
                    <a href="/Tyson_Elfors_Resume.pdf" download onClick={() => onClose?.()} className="flex items-center gap-3 px-3 py-2.5 text-sm text-chatgpt-text hover:bg-chatgpt-hover rounded-lg transition-smooth group">
                        <svg className="w-4 h-4 text-chatgpt-text-secondary group-hover:text-chatgpt-green" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
